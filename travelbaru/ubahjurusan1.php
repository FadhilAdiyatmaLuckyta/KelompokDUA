...
<body>
    ...
    <table width="25%" border="0">
            ...
            <tr> 
                ...
                <td><input type="text"  class="form_login" id="id_driver" name="id_driver"onkeypress="return hanyaAngka(event)" autocomplete="off" required value="<?= $jurusann["id_driver"]; ?>" ></td>
            </tr>
            <tr> 
                <td><label for="id_car">id_car</td>
                <td><input type="text"  class="form_login" id="id_car" name="id_car"onkeypress="return hanyaAngka(event)" autocomplete="off" required value="<?= $jurusann["id_car"]; ?>"></td>
            </tr>
