...
<body>
    ...
    <table width="25%" border="0">
            ...
            <tr> 
                ...
                <td><input type="text"  class="form_login" id="id_car" name="id_car" autocomplete="off" required value="<?= $jurusann["id_car"]; ?>"></td>
            </tr>
            <tr> 
            ...
            <tr> 
                ...
                <td><input type="time"  class="form_login" id="jam" name="jam" autocomplete="off" required value="<?= $jurusann["jam"]; ?>"></td>
            </tr>
            <tr> 
