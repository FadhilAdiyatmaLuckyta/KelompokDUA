...
<body>
    ...
    // Check If form submitted, insert form data into admin table.
    if(isset($_POST['Submit'])) {
        ...
        $result = mysqli_query($mysqli, "INSERT INTO tb_admin(id_admin,nama_user,telp,alamat,username,password) VALUES('$id_admin','$nama_admin','$telp','$alamat','$username','$password')");
