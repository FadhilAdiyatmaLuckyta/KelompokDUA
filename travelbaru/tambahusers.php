...
<body>
    ...
    <table width="25%" border="0">
            ...
            <tr> 
                ...
                <td><input type="text" maxlength="13" onkeypress="return hanyaAngka(event)" class="form_login" id="telepon" name="telepon" autocomplete="off" placeholder="Masukkan nomer telepon anda" required></td>
            </tr>
            <tr> 
