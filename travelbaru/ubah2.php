		...
		<div class="container-login100">
			...
			<form action="" method ="post">
				<form class="login100-form validate-form flex-sb flex-w">
					...
					<input type="text"  class="input100" id ="nama" name="nama" autocomplete="off" required value="<?= $user["nama"]; ?>">
					...
					<div class="wrap-input100 validate-input m-b-36">
					<input type="text"  class="input100" id="tmpt" name="tempat_lahir" autocomplete="off" required value="<?= $user["tempat_lahir"]; ?>" ></td>
						<span class="focus-input100"></span>
					</div>
					<span class="txt1 p-b-11">
						Tanggal Lahir
					...
					<div class="wrap-input100 validate-input m-b-36">
					<input type="date"  class="input100" id="tanggal_lahir" name="tanggal_lahir" autocomplete="off" required value="<?= $user["tanggal_lahir"]; ?>" ></td>
						<span class="focus-input100"></span>
					</div>
					<span class="txt1 p-b-11">
						Jenis Kelamin
					...
					<div class="wrap-input100 validate-input m-b-36">
					<input type="text" maxlength="16" onkeypress="return hanyaAngka(event)" class="input100" id="nod" name="nomer_id" autocomplete="off" required value="<?= $user["nomer_id"]; ?>">
						<span class="focus-input100"></span>
					</div>
					<span class="txt1 p-b-11">
						Telepon
					...
					<div class="wrap-input100 validate-input m-b-36">
					<input type="text" maxlength="13" onkeypress="return hanyaAngka(event)" class="input100" id="telepon" name="telepon" autocomplete="off"  required value="<?= $user["telepon"]; ?>">
						<span class="focus-input100"></span>
					</div>
					<span class="txt1 p-b-11">
						Alamat
					...
					<div class="wrap-input100 validate-input m-b-36">
					<input type="text"  class="input100" id="alamat" name="alamat" autocomplete="off" required value="<?= $user["alamat"]; ?>">
						<span class="focus-input100"></span>
					</div>
					<span class="txt1 p-b-11">
						Email
					...
					<div class="wrap-input100 validate-input m-b-36">
					<input type="text"  class="input100" id="username" name="username" autocomplete="off" required value="<?= $user["username"]; ?>">
						<span class="focus-input100"></span>
					</div>
