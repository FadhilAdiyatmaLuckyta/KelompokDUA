                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#"  aria-expanded="false" data-target="#submenu-8" aria-controls="submenu-8"><i class="fas fa-envelope"></i>Saran</a>
                            </li>
                            <li class="nav-item">
...
<div class="container">
  <h1><i class="fas fa-envelope"></i> DAFTAR SARAN</h1>
...
<tr>
        ...
        <td>
            ...
            <a href="hapussaran.php?kode=<?= $row["kode"]; ?>"" onclick="return confirm('yakin nih mau ngehapus ?');"><i class="far fa-trash-alt"></i> Hapus</a>
        </td>
        <td><?= $row["kode"]; ?></td>
        <td><?= $row["pengirim"]; ?></td>
        <td><?= $row["email"]; ?></td>
