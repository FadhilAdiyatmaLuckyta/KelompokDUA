		...
		<div class="container-login100">
			...
			<br>
				<form class="login100-form validate-form flex-sb flex-w">
					...
					<input type="text" name="username"  class="input100" placeholder="Masukkan Username" autocomplete="off" >
				...
				if($login) {
					if($username == "" || $password == "") {
						?> <script type="text/javascript">alert("ora oleh kosong hancok");</script> <?php
        					

					} else {
						$sql = mysqli_query("") or die (mysqli_error());
					}
				}
				?>
